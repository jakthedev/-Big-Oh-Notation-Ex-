...
public class ex {
		...
		public void addItemToArray(int newItem) {
			// Example of order of one, does'nt matter if its a 10,000 or 100,000
			// Item array it is going to preform exacly the same way 
		...
		public void linearSearchForValue(int value) {
			...
			String indexsWithValue = ""; // If I don't tell the program to find more than one it will actually 
			   
			startTime = System.currentTimeMillis(); // speed isn't the issue here.
		   ...
		   endTime = System.currentTimeMillis(); // Calc whenever the process ended
		...
		public void bubbleSort() {
	        // bubblesort gets really dramatic with searching 
	    ...
	    public void binarySearchForValue(int value) {
	       // Will see almost no affect once data increases
	 ...
	 public int partitionArray(int left, int right, int pivot) {
	    ...
	    public int BigONotation(int size) {
